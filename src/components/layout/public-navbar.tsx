  ...
  return (
    <>
      <header className="fixed top-0 left-0 right-0 z-50 transition-all duration-300">
        {/* ═════════════════════════════════════════════
            FANCYDIGITALS PROTOTYPE NOTICE BANNER
            ═════════════════════════════════════════════ */}
        <div
          className="w-full text-center py-2 px-4 text-xs font-medium flex items-center justify-center gap-1.5"
          style={{
        ...
        >
          <span>⚡ Prototype Version — Developed by</span>
          <a
            href="https://github.com/FancyDigitals"
            target="_blank"
