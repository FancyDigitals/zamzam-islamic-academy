  ...
  return (
    <div className="min-h-screen" style={{ background: "hsl(40, 40%, 97%)" }}>
      ...
      <div className="flex">
        ...
        >
          <SidebarLink href="/admin/dashboard" label="Dashboard" labelAr="لوحة التحكم" />
          <SidebarLink href="/admin/students" label="Students" labelAr="الطلاب" />
          <SidebarLink href="/admin/admissions" label="Admissions" labelAr="القبول" />
          <SidebarLink href="/admin/programmes" label="Programmes" labelAr="البرامج" />
          <SidebarLink href="/admin/courses" label="Courses" labelAr="المواد" />
          <SidebarLink href="/admin/results" label="Results" labelAr="النتائج" />
          <SidebarLink
                ...
                <div key={a.id} className="paper-card p-5 rounded-lg">
                  <div className="flex items-start justify-between gap-4">
                    <div className="flex-1 min-w-0">
                      ...
                      >
                        By {a.creatorFirstName} {a.creatorLastName} •{" "}
